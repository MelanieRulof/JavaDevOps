  ...
  stages {
        stage('Build, Test and Package') {
            ...
            post {
                ...
                failure {
                    mail bcc: '', body: "<b>Test fail</b><br>\n\<br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> URL de build: ${env.BUILD_URL}", cc: '', charset: 'UTF-8', from: '', mimeType: 'text/html', replyTo: '', subject: "ERROR TEST: Project name -> ${env.JOB_NAME}", to: "marianne.bousquet1@gmail.com";
                }
            }
        }
